...
<header >
    <div class="header focus clearfix">
        ...
        <form class="search-box r clearfix js-search-box  " style=" " action="//m.imooc.com/search/">
            <div class="l search-input hasnameinput-2">
                <input type="text" class="search js-search" name="words" value="vue" placeholder="请输入搜索关键词">
        ...
        <div id="pages-container">
            <div class="search-result">
                <dl class="nav-list clearfix">
                    <dd><a onclick="_hmt.push(['_trackEvent', '搜索结果页', 'click', '全站按钮点击次数'])" href="/search/?words=vue" class="cur">全站</a></dd>
                    <dd><a onclick="_hmt.push(['_trackEvent', '搜索结果页', 'click', '课程按钮点击次数'])" href="/search/course?words=vue" >课程</a></dd>
                    <dd><a onclick="_hmt.push(['_trackEvent', '搜索结果页', 'click', '猿问按钮点击次数'])" href="/search/wenda?words=vue" >猿问</a></dd>
                    <dd><a onclick="_hmt.push(['_trackEvent', '搜索结果页', 'click', '手记按钮点击次数'])" href="/search/article?words=vue" >手记</a></dd>
                </dl>
                ...
                <dl class="search-course-list">
                    <dd>
                        <a href="http://coding.imooc.com/class/196.html" class="clearfix">
                            <img src="//img3.mukewang.com/szimg/5aab7f270001909810800600-360-202.jpg" class="l">
                            <div class="l search-course-info">
                                <p class="tit"><span  class='highlight'>Vue</span>核心技术 Vue+Vue-Router+Vuex+SSR实战精讲</p>

                                <p class="desc">深入讲解Vue核心技术，展示Vue应用开发中的各种问题和最适合的解决方案</p>

                                <p class="info"><label>实战</label><span>355人在学 </span></p>
                            </div>
                        </a>
                    </dd>
                    <dd>
                        <a href="http://coding.imooc.com/class/107.html" class="clearfix">
                            <img src="//img1.mukewang.com/szimg/592e2eab0001302505660314-360-202.jpg" class="l">
                            <div class="l search-course-info">
                                <p class="tit">全网稀缺<span  class='highlight'>Vue</span> 2.0高级实战 独立开发专属音乐WebAPP</p>
                                <p class="desc">独一无二的Vue 2.0高级组件化开发实战课程，达到百度T4水平</p>
                                <p class="info"><label>实战</label><span>2778人在学 </span></p>
                            </div>
                        </a>
                    </dd>
                    <dd>
                        <a href="http://coding.imooc.com/class/119.html" class="clearfix">
                            <img src="//img3.mukewang.com/szimg/59eeb2340001f59105400300-360-202.jpg" class="l">
                            <div class="l search-course-info">
                                <p class="tit">开发微信全家桶项目<span  class='highlight'>Vue</span>/Node/MongoDB高级技术栈全覆盖</p>

                                <p class="desc">Nuxt/Vue SSR + Koa2 跨栈开发微信公众号+小程序</p>

                                <p class="info"><label>实战</label><span>673人在学 </span></p>
                            </div>
                        </a>
                    </dd>
                    <dd>
                        <a href="http://coding.imooc.com/class/91.html" class="clearfix">
                            <img src="//img4.mukewang.com/szimg/58ca659a00017c3705400300-360-202.jpg" class="l">
                            <div class="l search-course-info">
                                <p class="tit">最容易上手的<span  class='highlight'>Vue</span> 2.0入门实战教程</p>

                                <p class="desc">快速入门Vue 2.0，组件化开发一个数字产品电商平台</p>

                                <p class="info"><label>实战</label><span>3757人在学 </span></p>
                            </div>
                        </a>
                    </dd>
                    <dd>
                        <a href="http://coding.imooc.com/class/203.html" class="clearfix">
                            <img src="//img1.mukewang.com/szimg/5ac2dfe100014a9005400300-360-202.jpg" class="l">
                            <div class="l search-course-info">
                                <p class="tit"> Vue2.5开发去哪儿网App 从零基础入门到实战项目</p>

                                <p class="desc">从基础语法到完整项目，一套课程掌握Vue基础知识点</p>

                                <p class="info"><label>实战</label><span>232人在学 </span></p>
                            </div>
                        </a>
                    </dd>
                </dl>
