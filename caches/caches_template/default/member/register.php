        ...
        <section class="step1">
            ...
            <div class="account-form">
                ...
                <div class="account-form-group">
                    <!--<input type="tel" class="account-form-control js-input-name" data-callback="checkusername" data-validate="require-mobile-phone" placeholder="手机号">-->
                    <input type="text" id="username" name="username" size="36" class="account-form-control js-input-name" placeholder="手机号" data-callback="checkusername" data-validate="require-mobile-phone">
                    <div class="account-form-tip errorHint"></div>
                </div>
                <div class="account-form-group">
                    <!--<input type="tel" class="account-form-control js-input-name" data-callback="checkusername" data-validate="require-mobile-phone" placeholder="手机号">-->
                    <input type="password" id="password" name="password" size="36" class="account-form-control js-input-name" placeholder="密码" data-callback="checkusername" data-validate="require-mobile-phone">
                    <div class="account-form-tip errorHint"></div>
                </div>
                <div class="account-form-group">
                    <!--<input type="tel" class="account-form-control js-input-name" data-callback="checkusername" data-validate="require-mobile-phone" placeholder="手机号">-->
                    <input type="password" id="pwdconfirm" name="pwdconfirm" size="36" class="account-form-control js-input-name" placeholder="请确认密码" data-callback="checkusername" data-validate="require-mobile-phone">
                    <div class="account-form-tip errorHint"></div>
                </div>
                <div class="account-form-group button-row">
                    <div class="account-form-tip js-error"></div>
                    <!--<a href="javascript:void(0)" class="account-form-btn js-btn-next">注册</a>-->
                    <input style="width: 100%;" type="submit" name="dosubmit" value="注册" class="account-form-btn js-btn-next">
                </div>
                </form>
            </div>
            <?php } ?>
            ...
            <div class="account-form">
                <div class="account-form-group">
                    <input type="number" oninput="if(value.length>4)value=value.slice(0,4)"
                           class="account-form-control verify js-phone-verify" data-validate="require-string"
                           data-maxlength="4" data-minlength="4" placeholder="请输入验证码">
                ...
                <div class="account-form-group">
                    <input type="password" class="account-form-control js-input-password"
                           data-validate="require-password" placeholder="6-16位密码，区分大小写，不能用空格">
...
<script type="text/javascript" src="/static/wap/static/common/js/common_03ec857.js"></script>
<script type="text/javascript" src="/static/wap/static/common/js/moco.min_281f9ec.js"></script>
<script type="text/javascript" src="/static/wap/static/js/account/register_43d9aa8.js"></script>
</body>
</html>
