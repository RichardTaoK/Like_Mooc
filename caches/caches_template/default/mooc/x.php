    ...
    <div id="middle" class="container">
        <div id="pages-container">
            ...
            <dl class="js-course-list course-list clearfix">
                ...
                <dd>
                    <?php if($userid) { ?>
                    <a  class="clearfix" href="/index.php?m=mooc&c=index&a=course&id=<?php echo $v['id'];?>">
                        <?php } else { ?>
                        ...
                        <div class="l course-info"><p class="tit"><?php echo $v['title'];?></p>
                            <p class="desc"><?php echo $v['description'];?></p>
                            <p class="info">入门<em>·</em><?php echo $v['view_count'];?>人在学 </p></div>
                    </a>
                </dd>
                <?php $n++;}unset($n); ?>
            </dl>
...
//            这里面的id是告诉页面他去course表里找的是哪个id数据号
            loading.show();
            $.getJSON(
                `/index.php?m=mooc&c=index&a=s&id=<?php echo $id;?>&type_id=${type_id}&order=${order}`
            ).done(function (data) {
                loading.hide();
